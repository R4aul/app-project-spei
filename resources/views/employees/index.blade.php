    ...
    <div class="mb-6 bg-gray-50 p-6 rounded-lg shadow-md">
        <form action="{{ route('employees.index') }}" method="GET" class="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div class="flex flex-col">
                ...
                <select name="profile" id="profile" class="border border-gray-300 rounded-lg p-2 focus:outline-none focus:border-blue-500">
            ...
            <div class="flex flex-col">
                ...
                <select name="cell" id="cell" class="border border-gray-300 rounded-lg p-2 focus:outline-none focus:border-blue-500">
                ...
                @foreach ($employees as $employee)
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="flex items-center px-6 py-4">
                            <a href="{{ route('employees.edit', $employee) }}" class="font-medium text-blue-600 hover:underline">
                                Editar
                            </a>
                        </td>
                    </tr>
